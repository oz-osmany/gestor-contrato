let redRooms=(red_3,service,red_4, red_5,red_6,
             resul_sup,cont_fecha,diner31_ad,diner24_ad,diner31,diner24,st,
              ...
              adult,adult_cost,mups,supls_cs,adult_cs,st_cs,child_cs,map)=>{
                        ...
                        if(red_5!=""){
                            ...
                            if(diner24_ad!="" || diner31_ad!=""){
                                if(e===2){
                                    ...
                                    //Para Cost
                                    let temp=(gr[i]*2)+(gr[i]-(gr[i]*red_3))+(gr[i]-(gr[i]*red_4))+(gr[i]-(gr[i]*red_5))+((parseInt(diner24_ad))*5);
                                    temp=temp.toFixed(2);
                                    adult_cost[e][i]=""+temp;
                                    //Para Cost-Sell
                        ...
                        if(red_3!=""){
                            ...
                            if(diner24_ad!="" || diner31_ad!=""){
                                if(e===2){
                                    ...
                                    //Para cost
                                    let temp=((gr[i]*2)+(gr[i]-(gr[i]*red_3)))+((parseInt(diner24_ad))*4);
                                    st[e][i]=""+(((gr[i]*2)+(gr[i]-(gr[i]*red_3)))+((parseInt(diner24_ad))*4))/divide;
                                    //Para Cost-Sell
